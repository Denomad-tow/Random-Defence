...
// 좌표다. gapCol은 0(맨 왼쪽 바깥) ~ FIELD_COLS(맨 오른쪽 바깥), gapRow는 0(맨 위,
...
export const MAP_PRESETS: MapPreset[] = [
  ...
  { id: 'edge-left', name: '왼쪽 벽 타기', waypoints: [{ gapCol: 0, gapRow: 0 }, { gapCol: 2, gapRow: 1 }, { gapCol: 4, gapRow: 2 }, { gapCol: 1, gapRow: 3 }] },
  { id: 'edge-right', name: '오른쪽 벽 타기', waypoints: [{ gapCol: 5, gapRow: 0 }, { gapCol: 3, gapRow: 1 }, { gapCol: 1, gapRow: 2 }, { gapCol: 4, gapRow: 3 }] },
